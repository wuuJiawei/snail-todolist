...
- [ ] M1.1 修正不表达有效业务行为的既有测试生成器/断言 — 待开始
- [ ] M1.2 补充任务完成、放弃、删除、恢复、排序行为测试 — 待开始
- [ ] M1.3 补充项目、任务、标签关联与导入导出测试 — 待开始
...
- [ ] M4.1 迁移任务、项目、标签 Query 和 mutation — 待开始
- [ ] M4.2 迁移认证、打卡、番茄钟、搜索、附件与资料访问 — 待开始
- [ ] M4.3 将项目删除迁移、恢复关系、导入等流程放入 UseCase — 待开始
- [ ] M4.4 清除 Component、Context、Store、业务 Hook 的直接 Supabase SDK 调用 — 待开始
