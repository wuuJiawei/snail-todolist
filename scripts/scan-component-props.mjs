...
const COMPONENTS_DIR = path.join(__dirname, '../web/src/components');
...
function analyzeComponent(filePath) {
  ...
  const existingPropsInterfaces = new Set();
...
function main() {
  ...
  const outputPath = path.join(__dirname, '../.kiro/specs/web-code-optimization/components-props-analysis.json');
